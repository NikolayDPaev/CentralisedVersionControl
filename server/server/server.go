...
// sendEmptyRequest is used to unblock the server from waiting on accept()
...
// handleClient is a goroutine that handles incomming client.
...
// runServer is the server routine.
